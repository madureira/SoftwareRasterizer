...
{
    Vec2 r = vec2_add(vec2_create(1.0f, 2.0f), vec2_create(3.0f, 4.0f));
...
{
    Vec2 r = vec2_subtract(vec2_create(5.0f, 7.0f), vec2_create(2.0f, 3.0f));
...
{
    Vec2 r = vec2_multiply(vec2_create(2.0f, 3.0f), 4.0f);
...
{
    Vec2 r = vec2_divide(vec2_create(6.0f, 9.0f), 3.0f);
...
{
    Vec2 r = vec2_negate(vec2_create(1.0f, -2.0f));
...
{
    TEST_ASSERT_FLOAT_EQ(ctx, vec2_dot(vec2_create(1.0f, 0.0f), vec2_create(0.0f, 1.0f)), 0.0f, EPS);
}

static void test_dot_parallel(TestContext* ctx)
{
    TEST_ASSERT_FLOAT_EQ(ctx, vec2_dot(vec2_create(1.0f, 0.0f), vec2_create(1.0f, 0.0f)), 1.0f, EPS);
}

static void test_length_squared(TestContext* ctx)
{
    TEST_ASSERT_FLOAT_EQ(ctx, vec2_length_squared(vec2_create(3.0f, 4.0f)), 25.0f, EPS);
}

static void test_length(TestContext* ctx)
{
    TEST_ASSERT_FLOAT_EQ(ctx, vec2_length(vec2_create(3.0f, 4.0f)), 5.0f, EPS);
}
...
{
    TEST_ASSERT_FLOAT_EQ(ctx, vec2_distance_squared(vec2_zero(), vec2_create(3.0f, 4.0f)), 25.0f, EPS);
}

static void test_distance(TestContext* ctx)
{
    TEST_ASSERT_FLOAT_EQ(ctx, vec2_distance(vec2_zero(), vec2_create(3.0f, 4.0f)), 5.0f, EPS);
}

static void test_distance_same_point(TestContext* ctx)
{
    TEST_ASSERT_FLOAT_EQ(ctx, vec2_distance(vec2_create(2.0f, 3.0f), vec2_create(2.0f, 3.0f)), 0.0f, EPS);
}
...
{
    Vec2 n = vec2_normalize(vec2_create(3.0f, 4.0f));
...
static void test_try_normalize_success(TestContext* ctx)
{
    ...
    TEST_ASSERT_TRUE(ctx, vec2_try_normalize(vec2_create(3.0f, 4.0f), &result));
...
{
    Vec2 result = vec2_create(1.0f, 0.0f);
    TEST_ASSERT_FALSE(ctx, vec2_try_normalize(vec2_zero(), &result));
    TEST_ASSERT_TRUE(ctx, vec2_equals_exact(result, vec2_create(1.0f, 0.0f)));
}

static void test_try_normalize_null_returns_false(TestContext* ctx)
{
    TEST_ASSERT_FALSE(ctx, vec2_try_normalize(vec2_create(1.0f, 0.0f), NULL));
}
...
{
    Vec2 result = vec2_zero();
    TEST_ASSERT_TRUE(ctx, vec2_try_divide(vec2_create(6.0f, 9.0f), 3.0f, &result));
...
{
    Vec2 result = vec2_zero();
    TEST_ASSERT_FALSE(ctx, vec2_try_divide(vec2_create(1.0f, 1.0f), 0.0f, &result));
}

static void test_try_divide_null_returns_false(TestContext* ctx)
{
    TEST_ASSERT_FALSE(ctx, vec2_try_divide(vec2_create(1.0f, 0.0f), 2.0f, NULL));
}
...
{
    Vec2 from = vec2_zero();
    Vec2 to = vec2_create(10.0f, 10.0f);
...
{
    Vec2 r = vec2_lerp(vec2_zero(), vec2_create(10.0f, 10.0f), 0.5f);
    TEST_ASSERT_TRUE(ctx, vec2_equals_epsilon(r, vec2_create(5.0f, 5.0f), EPS));
}
...
{
    Vec2 from = vec2_zero();
    TEST_ASSERT_TRUE(ctx, vec2_equals_exact(vec2_lerp_clamped(from, vec2_create(10.0f, 10.0f), -1.0f), from));
}
...
{
    TEST_ASSERT_TRUE(ctx, vec2_equals_exact(vec2_create(1.0f, 2.0f), vec2_create(1.0f, 2.0f)));
}

static void test_equals_exact_different(TestContext* ctx)
{
    TEST_ASSERT_FALSE(ctx, vec2_equals_exact(vec2_create(1.0f, 2.0f), vec2_create(1.0f, 2.1f)));
}

static void test_equals_epsilon_within(TestContext* ctx)
{
    Vec2 a = vec2_create(1.0f, 2.0f);
    Vec2 b = vec2_create(1.0f + 1e-7f, 2.0f);
...
{
    Vec2 a = vec2_create(1.0f, 2.0f);
    Vec2 b = vec2_create(1.0f + 1e-4f, 2.0f);
    TEST_ASSERT_FALSE(ctx, vec2_equals_epsilon(a, b, 1e-6f));
}

static void test_near_within_distance(TestContext* ctx)
{
    TEST_ASSERT_TRUE(ctx, vec2_near(vec2_zero(), vec2_create(3.0f, 4.0f), 5.0f));
}

static void test_near_outside_distance(TestContext* ctx)
{
    TEST_ASSERT_FALSE(ctx, vec2_near(vec2_zero(), vec2_create(3.0f, 4.0f), 4.0f));
}
...
static void test_add_inplace(TestContext* ctx)
{
    ...
    vec2_add_inplace(&v, vec2_create(3.0f, 4.0f));
...
{
    Vec2 v = vec2_create(5.0f, 7.0f);
    vec2_subtract_inplace(&v, vec2_create(2.0f, 3.0f));
    TEST_ASSERT(ctx, v.x == 3.0f);
    TEST_ASSERT(ctx, v.y == 4.0f);
}
